...
ALLOWED_HOSTS = ['127.0.0.1','netman.azurewebsites.net']
...
INSTALLED_APPS = [
    ...
    'whitenoise.reunserver_nostatic',
...
ROOT_URLCONF = 'NM.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'NM/web-app')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'NM.wsgi.application'
