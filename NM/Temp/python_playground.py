...
tn.write('username @username algorithm-type scrypt secret locpass101\n')
...
tn.write('radius server <name-SERVER-R> \n')
tn.write('address ipv4 <ip address of server- 192.168.0.2> auth-port 1812 acct-port 1813 \n')
tn.write('key <password-RADPASS> \n')
tn.write('exit \n')
...
tn.write('ospfv3 10 ipv4 area 0\n')
tn.write('ospfv3 10 ipv6 area 10_area\n')
tn.write('ospfv3 encryption ipsec spi 1000 esp null sha1 1231321\n')
tn.write('ip nat inside \n')
tn.write('zone-member security INSIDE \n')
tn.write('no shutdown \n')
tn.write('!\n')
...
tn.write('lifetime 3600 \n')
tn.write('exit\n')
tn.write('crypto isakmp key passwored address ipv6 @isakmp_ipv6_remote_peer/64\n')
tn.write('crypto keyring keyring\n')
tn.write('pre-shared-key address ipv6 2013:fecd:3145:6151::1/64 key 6 ringpass\n')
tn.write('exit \n')
tn.write('crypto ipsec transform-set secrset1 set esp-aes 256 esp-sha-hmac \n')
tn.write('mode tunnel \n')
tn.write('exit \n')
tn.write('crypto ipsec profile profile0\n')
tn.write('set transform-set secrset1\n')
tn.write('exit \n')
